...
const getPersonaje_Trabajo = async (req, res) => {
    try{
        ...
        console.error(error);
        res.status(500).json({error: 'Error al ver las relaciones Persona_Trabajo'});
    }
}
...
const getPersonaje_TrabajobyId = async (req, res) => {
    try{
        ...
        console.error(error);
        res.status(500).json({error: 'Error al ver la relación Persona_Trabajo'});
    }
} 
...
const updatePersonaje_Trabajo = async (req, res) => {
    try{
        ...
        console.error(error);
        res.status(500).json({error: 'Error al actualizar la relación Persona_Trabajo'});
    }
}
...
const deletePersonaje_Trabajo = async (req, res) => {
    try{
        ...
        console.error(error);
        res.status(500).json({error: 'Error al eliminar la relación Persona_Trabajo'});
    }
}
