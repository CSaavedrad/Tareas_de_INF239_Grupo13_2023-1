...
const getPersonaje_reino = async (req , res) => {
    try{
        ...
        console.error(error);
        res.status(500).json({error: 'Error al ver las relaciones Persona_Reino'});
    }
}
...
const getPersonaje_reinobyIds = async (req, res) => {
    try{
        ...
        console.error(error);
        res.status(500).json({error: 'Error al ver la relación Persona_Reino'});
    }
}
...
const updatePersonaje_reino = async (req, res) => {
    try{
        ...
        console.error(error);
        res.status(500).json({error: 'Error al actualizar la relación Persona_Reino'});
    }
}
...
const deletePersonaje_reino = async (req, res) => {
    try{
        ...
        console.error(error);
        res.status(500).json({error: 'Error al eliminar la relación Persona_Reino'});
    }
}
