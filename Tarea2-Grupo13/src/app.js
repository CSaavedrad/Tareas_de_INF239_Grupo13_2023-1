...
app.get('/api/personajes/:id/trabajos', PersonajesController.getPersonajeTrabajos)
app.get('/api/personajes/:id/reinos', PersonajesController.getPersonajeReinos)
...
app.get('/api/reinos/:id/personajes', ReinosController.getReinoPersonajes)
app.get('/api/reinos/:id/defensas', ReinosController.getReinoDefensas)
app.get('/api/reinos/:id/diplomacias', ReinosController.reinoDiplomacias)
...
app.get('/api/trabajos/:id/personajes', TrabajosController.getTrabajoPersonajes)
